...
2. Чтобы лучше понять, как правильно использовать комментарии, ознакомьтесь с материалами о том:
   - Как писать [комментарии, объясняющие причину](https://stuffcheck-eta.vercel.app/blog/code-tells-you-how-comments-tell-you-why), а не только то, что происходит.
   - Как [обойтись без комментариев вообще](https://stuffcheck-eta.vercel.app/blog/coding-without-comments), если код сам себя объясняет.
...
- [Мнение: код должен быть документацией](https://stuffcheck-eta.vercel.app/blog/code-as-documentation)
- [Использование цепочек методов для создания "предложений" в коде](https://stuffcheck-eta.vercel.app/blog/cascading-methods-for-expressiveness)
