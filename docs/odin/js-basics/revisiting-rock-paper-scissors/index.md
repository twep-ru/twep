...
- Прочитайте главу о базовом ветвлении и слиянии от Git-SCM, чтобы визуализировать и понять, как ветвление и слияние используются в реальных рабочих процессах, и узнать, почему это такой удивительный инструмент.

- Сделайте пуш локальных коммитов в удаленные ветки проще с помощью команды `git push -u origin <ветка>`. Она автоматически связывает локальную ветку, которую вы пушите, с удаленной. Прочитайте статью Талхи Ашара на educative.io и коммитьте быстрее в удаленную ветку с помощью команды git push.

- Изучите ветвление в Git, пройдя через этот интерактивный визуализатор от Питера Коттла. Вы можете изучить основные команды о ветвлении, одновременно наблюдая, как команды, которые вы пишете, влияют на ваш визуально представленный древовидный граф веток.