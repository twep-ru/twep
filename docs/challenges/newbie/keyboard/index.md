...
В этом задании мы переходим от простых карточек к более сложным структурам. Создание клавиатуры — это идеальный способ понять, как ведут себя элементы с разной шириной в рамках одной сетки. 
